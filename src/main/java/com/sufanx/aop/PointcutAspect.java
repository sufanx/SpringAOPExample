...
public class PointcutAspect {
    ...
    /*3、this*/
    @Before(value = "this(com.sufanx.service.IPointcutService)")
    public void thisTest1(JoinPoint jp) {
        dump("this(cn.javass..IPointcutService)", jp);
    }
    
    @Before(value = "this(com.sufanx.service.IIntroductionService)")
    ...
    @Before(value = "target(com.sufanx.service.IPointcutService)")
    public void targetTest1(JoinPoint jp) {
        dump("target(cn.javass..IPointcutService)", jp);
    }
    
    @Before(value = "target(com.sufanx.service.IIntroductionService)")
    public void targetTest2(JoinPoint jp) {
        //注意与this(com.sufanx.service.IIntroductionService)区别
    ...
    public void annotationWithinTest1(JoinPoint jp) {
        dump("@within(com.sufanx.Secure)", jp);
    }
    /*7、@target*/
    @Before(value = "@target(com.sufanx.Secure)")
    public void annotationTargetTest1(JoinPoint jp) {
        dump("@target(com.sufanx.Secure)", jp);
    }
    /*8、@args*/
    @Before(value = "@args(com.sufanx.Secure)")
    public void annotationArgsTest1(JoinPoint jp) {
        dump("@args(com.sufanx.Secure)", jp);
    }
    /*9、@annotation*/
    @Before(value = "@annotation(com.sufanx.Secure)")
    public void annotationAnnotationTest1(JoinPoint jp) {
        dump("@annotation(com.sufanx.Secure)", jp);
    }
    /*10、bean*/
    ...
    @Pointcut(value="@args(com.sufanx.Secure)")
    ...
    @Before(value = "com.sufanx.aop.ReferencePointcutAspect.pointcut()")
    public void referencePointcutTest2(JoinPoint jp) {
        dump("com.sufanx.aop.ReferencePointcutAspect.pointcut()", jp);
    }
