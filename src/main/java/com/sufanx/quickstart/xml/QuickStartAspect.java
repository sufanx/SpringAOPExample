...
public class QuickStartAspect {

    /**
     * 前置通知
     */
//    public void beforeAdvice(String username) {
//        System.out.println("> before advice：准备登录");
//    }
     ...
     * @param password 密码
     */
    public void beforeAdvice(String username, String password) {
        System.out.println("> before advice：" + username + "正在尝试登录");
    }
    ...
    public Object aroundAdvice(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        System.out.println("> around after advice：劫持登录结束，" + message);
        return retVal;
    }
