...
public class ParameterAspect {
    ...
    @Before("execution(* injectForJointPoint(*))")
    ...
    @Before(value = "execution(* injectForJointPoint(*))")
...
//    @Before(value = "args(param) && target(bean) && @annotation(secure)", argNames = "jp,param,pointcutService,secure")
//    public void before5(JoinPoint jp, String param, PointcutServiceImpl pointcutService, Secure secure) {
